...
export default function DatabaseManager({
  ...
  const handleUploadSQLiteFile = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      // Both .json and .db files generated by AnimaLar contain valid JSON data
      ...
      reader.onload = async (event) => {
        try {
          ...
          try {
            ...
            throw new Error("Formato de ficheiro incorreto ou corrompido. Certifique-se de carregar um ficheiro .json ou .db válido exportado pelo AnimaLar.");
          }
